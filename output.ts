describe("test test function logic", () => {
    describe("test test function logic", () => {
        let mapSpy = jest.spyOn(participants, "map");
        let idSpy = jest.spyOn(p, "id");
    ...
    describe("test test function logic", () => {
        let findAllNotBlacklistedSpy = jest.spyOn(Participant, "findAllNotBlacklisted");
        let lengthSpy = jest.spyOn(participants, "length");
        let sendInvitationSpy = jest.spyOn(VirtualGraduationEmailService, "sendInvitation");
        let lengthSpy = jest.spyOn(processedParticipants, "length");

        test(
            "sendInvitationsToNewParticipants should call findAllNotBlacklistedSpy",
            async () => {
        ...
        test(
            "sendInvitationsToNewParticipants should call sendInvitationSpy",
            async () => {
                VirtualGraduationEmailSchedulerService.sendInvitationsToNewParticipants();
    ...
    describe("test test function logic", () => {
        let findAllNotBlacklistedSpy = jest.spyOn(Participant, "findAllNotBlacklisted");
        let lengthSpy = jest.spyOn(participants, "length");
        let sendConfirmationSpy = jest.spyOn(VirtualGraduationEmailService, "sendConfirmation");
        let lengthSpy = jest.spyOn(processedParticipants, "length");

        test(
            "sendConfirmationToParticipants should call findAllNotBlacklistedSpy",
            async () => {
        ...
        test(
            "sendConfirmationToParticipants should call sendConfirmationSpy",
            async () => {
                VirtualGraduationEmailSchedulerService.sendConfirmationToParticipants();
    ...
    describe("test test function logic", () => {
        let findAllNotBlacklistedSpy = jest.spyOn(Participant, "findAllNotBlacklisted");
        let lengthSpy = jest.spyOn(participants, "length");
        let sendRejectionSpy = jest.spyOn(VirtualGraduationEmailService, "sendRejection");
        let lengthSpy = jest.spyOn(processedParticipants, "length");

        test(
            "sendRejectionToParticipants should call findAllNotBlacklistedSpy",
            async () => {
    ...
    describe("test test function logic", () => {
        let findAllNotBlacklistedSpy = jest.spyOn(Participant, "findAllNotBlacklisted");
        let lengthSpy = jest.spyOn(participants, "length");
        let sendFirstReminderSpy = jest.spyOn(VirtualGraduationEmailService, "sendFirstReminder");
        let lengthSpy = jest.spyOn(processedParticipants, "length");

        test(
            "sendFirstReminderToParticipants should call findAllNotBlacklistedSpy",
            async () => {
        ...
        test(
            "sendFirstReminderToParticipants should call sendFirstReminderSpy",
            async () => {
                VirtualGraduationEmailSchedulerService.sendFirstReminderToParticipants();
    ...
    describe("test test function logic", () => {
        let findAllNotBlacklistedSpy = jest.spyOn(Participant, "findAllNotBlacklisted");
        let lengthSpy = jest.spyOn(participants, "length");
        let sendSecondReminderSpy = jest.spyOn(VirtualGraduationEmailService, "sendSecondReminder");
        let lengthSpy = jest.spyOn(processedParticipants, "length");

        test(
            "sendSecondReminderToParticipants should call findAllNotBlacklistedSpy",
            async () => {
        ...
        test(
            "sendSecondReminderToParticipants should call sendSecondReminderSpy",
            async () => {
                VirtualGraduationEmailSchedulerService.sendSecondReminderToParticipants();
    ...
    describe("test test function logic", () => {
        let findAllNotBlacklistedSpy = jest.spyOn(Participant, "findAllNotBlacklisted");
        let lengthSpy = jest.spyOn(participants, "length");
        let sendEmailRecoverySpy = jest.spyOn(VirtualGraduationEmailService, "sendEmailRecovery");
        let lengthSpy = jest.spyOn(processedParticipants, "length");

        test(
            "sendEmailRecoveryToParticipants should call findAllNotBlacklistedSpy",
            async () => {
        ...
        test(
            "sendEmailRecoveryToParticipants should call sendEmailRecoverySpy",
            async () => {
                VirtualGraduationEmailSchedulerService.sendEmailRecoveryToParticipants();
    ...
    describe("test test function logic", () => {
        let findAllSpy = jest.spyOn(Event, "findAll");
        let EmailScheduledSpy = jest.spyOn(EventPreviewEmailStatus, "EmailScheduled");
        let mapSpy = jest.spyOn(eventsReadyPreview, "map");
        let clientSpy = jest.spyOn(eventWithPreview, "client");
        let clientSpy = jest.spyOn(eventWithPreview, "client");
        let mapUserToRecipientSpy = jest.spyOn(UserEmailService, "mapUserToRecipient");
        let sendClipPreviewReadyForUsersSpy = jest.spyOn(UserEmailService, "sendClipPreviewReadyForUsers");
        let updateSpy = jest.spyOn(eventWithPreview, "update");
        let EmailSendSpy = jest.spyOn(EventPreviewEmailStatus, "EmailSend");
        ...
        test(
            "sendClipPreviewReadyToUsers should call mapUserToRecipientSpy",
            async () => {
                VirtualGraduationEmailSchedulerService.sendClipPreviewReadyToUsers();
        ...
        test(
            "sendClipPreviewReadyToUsers should call sendClipPreviewReadyForUsersSpy",
            async () => {
                VirtualGraduationEmailSchedulerService.sendClipPreviewReadyToUsers();
