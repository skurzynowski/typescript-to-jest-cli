...
namespace Transformer {
        ...
        return builders.expressionStatement(
            ...
            builders.callExpression(
                ...
                [
                    ...
                    builders.arrowFunctionExpression([], builders.blockStatement(
                        body
                    ))
                ]
            )
                    ...
                    builders.arrowFunctionExpression.from(
                        {
                            ...
                            body: builders.blockStatement.from({
                                body: [
                                    callFunction(testFunctionName, "VirtualGraduationEmailSchedulerService"),
                                    expectToBeCalled(spyName)
                                ]
                            }),
                            params: [],
                        }
    ...
    */
                ...
                builders.variableDeclarator(
                    ...
                    builders.callExpression(
                        builders.memberExpression(
                            builders.identifier("jest"),
                            builders.identifier("spyOn")
                        ), [
                        //Object to mock
    ...
    export function genEmptyFunctionName(nodes: n.FunctionDeclaration[]): n.ASTNode[] {
        return nodes.map((el) => builders.functionDeclaration(builders.identifier(el.id.name), [], builders.blockStatement([])));
    }
}
